...
visualization provides a mechanism to encapsulate algorithms and then
couple them together in a variety of ways.  The visualization pipeline has
been in existence for over twenty years, and over this time many variations
and improvements have been proposed.  This paper provides a literature
review of the most prevalent features of visualization pipelines and some
of the most recent research directions.


\section{Introduction}
\label{sec:Introduction}

A visualization system must ingest, transform, display, and record data.
These operations are actualized by a collection of loosely coupled
algorithms.  Many applications dictate flexibility in the way these
operations are applied to data, and the \keyterm{visualization pipeline}
provides a simplifying metaphor.

The combination of simplicity and power makes the visualization pipeline is
the most prevalent metaphor encountered today.  It provides the key
...
also used internally be a number of other applications including
