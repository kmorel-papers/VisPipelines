...
\PARstart{T}{he} field of scientific visualization was launched with the 1987 National
...
\begin{description}[\setlabelwidth{Extents}]
...
geometry\lcite{VoPhD} and render\lcite{Stuart2010,VoPhD}.  The MapReduce
...
\fix{There might be a MapReduce paper coming out in LDAV.  Should add that
  above when possible.}
...
\begin{biography}[{\includegraphics[width=1in]{images/PhotoMoreland}}]{Kenneth Moreland}
